...
*
     ...
     :      /DEF11/FMTOAU,AUMAMU
*
*   Physical constants from http://physics.nist.gov (2014)
*   Physical constants: see description below.
*
      PARAMETER (AINFCM =       0.529 177 210 67  D-08,
     :           ALFAI  =     137.035 999 139  D 00,
     :           CCMPS  =       2.99 792 458   D 10,
     :           EESU   =       4.803 204 673  D-10,
     :           EMEG   =       9.109 383 56   D-28,
     :           EMEAMU =       5.485 799 090 70 D-04,
     :           EMPAMU =       1.007 276 466 879  D 00,
     :           HBARES =       1.054 571 800  D-27,
     :           RINFEV =      13.605 693 009  D 00,
     :           RINFK  = 109 737.315 685 08   D 00)
*
