...
*
     ...
     :    (G92MIX .NE. 'G92MIX')) THEN
      ...
      ENDIF
*
      READ (25) NELECT,NCFT,NWT,NVECT,NVECSIZT,NBLOCK
c     READ (25) NELECT,NCFT,NWT
...
*
      READ (25) NB,NCF,NVEC,IATJP,IASPA
...
c     READ (25) (IATJPO(I),IASPAR(I),I = 1,NVEC)
      DO I = 1,NVEC
      IATJPO(I)=IATJP
      IASPAR(I)=IASPA
      ENDDO
