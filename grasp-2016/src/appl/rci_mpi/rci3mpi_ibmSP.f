...
************************************************************************
      ...
      CHARACTER*128 NAME, isofile, file1, file2
...
*=======================================================================
      file1 = '  '; file2 = '  '; startdir = '  '; permdir = '  ';
      tmpdir = '  '; NAME = '  '; isofile = '  ';

      CALL startmpi2 (myid, nprocs, host, lenhost, ncount1,
     &    startdir, permdir, tmpdir, 'RCI3MPI', lentmp,lenperm)
...
*=======================================================================
      ...
      IF (myid .EQ. 0) THEN
         ...
         isofile = permdir(1:lenperm-1) // '/isodata '
         NAME    = permdir(1:lenperm-1) // '/' // NAME(1:lenname) // ' '
...
*=======================================================================
      ...
      if(myid == 0) file1 = name(1:lenname-1) // '.c'
      CALL cslhmpi (file1, nore, nblk0, idblk)
      if(myid == 0) file1 = name(1:lenname-1) // '.w'
      CALL SETRES (isofile, file1, idblk)
