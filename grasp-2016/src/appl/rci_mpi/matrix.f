...
*   Removed imethod from argument list    CFF, April 2016              *
*                                                                      *
************************************************************************
...
! AK: This is required for ifort -i8 to match the BD declaration
...
cAK    INTEGER*4 variables required for compatibility with ifort -i8
      INTEGER*4 IQA,JQSA,JCUPA,NVEC4,IVEC,jblock4,ncf4,jpo4,ipar4,
     &  iccmin
      integer*8 nelmnt
...
Ctc 4/10/2013: large calculations
      INTEGER*8 NELMNT_a
Ctc
...
*           ...eav, nelmnt are also obtained from genmat
     ...
     :        slf_en)
               ...
               ! since other programs may assume the existence of them.
...
*        ------------------------
        CALL genmat (atwinv, jblock, myid, nprocs, elsto, irestart,
     :     slf_en)
c        write (*,*) 'Matrix5,myid=',myid
        CALL genmat2 (irestart, nelmnt_a, elsto)
c        write (*,*) 'Matrix6,myid=',myid
*
...
c        write (*,*) 'Matrix61,myid=',myid
        CALL MANEIG (iiatjpo, iiaspar, nelmnt_a, imethod)
c        write (*,*) 'Matrix7,myid=',myid
*
