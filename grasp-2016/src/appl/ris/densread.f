...
* The electron density and the NMS
      POINTER (PNDENS1,DENS1(1)),(PNDENS2,DENS2(1))
* The radial axpectation values R,R2
      POINTER (PNDENS3,DENS3(1)),(PNDENS4,DENS4(1))
*  and R-1 and R-2
      POINTER (PNDENS5,DENS5(1)),(PNDENS6,DENS6(1))
      POINTER (PNDENS7,DENS7(1))

*      POINTER (PNTEMT1,ELEMNT1(1)),(PNTEMT2,ELEMNT2(1))
**      POINTER (PNTEMT3,ELEMNT3(1)),(PNTEMT4,ELEMNT4(1))
**      POINTER (PNTEMT5,ELEMNT5(1)),(PNTEMT6,ELEMNT6(1))
