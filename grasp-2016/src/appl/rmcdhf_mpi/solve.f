...
*                                                                      *
*   Call(s) to: [RSCF92]: COUNT, ESTIM, IN, NEWE, OUT,
...
*
    ...
    2    CONTINUE
      ...
      ENDIF
!     print *, "solve0: p0=", p0, "myid=", myid
*
*   Generate the continuous solution
*
      MTPC = MAX (MTPH,MTPI)
      ALFA = -(QJPII-QJPOI)/(QJPIH-QJPOH)
!     print*,"solve1: QJPII=", QJPII, "QJPOI=",QJPOI,"myid=",myid
!     print*,"solve1: QJPIH=", QJPIH, "QJPOH=",QJPOH,"myid", myid
!     print*,"solve1: alfa=", alfa, "myid=", myid
      P0H = P0
      P0 = P0*(1.0D 00+ALFA)
      DO 3 I = 1,MTPC
         P(I) = P(I)+ALFA*PH(I)
