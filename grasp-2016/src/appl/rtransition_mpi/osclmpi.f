...
CGG  lbl
      IF(IBLKI .EQ. 1) THEN
         CALL LDLBL2 (FULLNAME(2))
         IF(MYID.EQ.0.AND.IOPEN_STATUS1.EQ.0.AND.IOPEN_STATUS2.EQ.0)THEN
...
*
CGG      NVECPR = NVECFF+NVECII*(NVECFF-1)
