...
C      WRITE (0,*) 'Perform duplicate check and remove them ?'
C      CheckDuplicate = getyn()
      CheckDuplicate = .false.

      OPEN (19, FILE = input, STATUS = 'OLD', FORM = 'FORMATTED',
     :          ACTION='READWRITE')
C      OPEN (20, FILE = output, STATUS = 'UNKNOWN', FORM = 'FORMATTED')
...
!         if (n.ne.0) then       FOR SYM WE SHOULD PRINT ALL ORBITALS IN
!         THE HEADER THE
            norb(i) = 1
!         end if
      end do
...
* Write the orbitals that have been found in the CSFs
 ...
 9999    CLOSE (iunit)
      ...
      END
!NewPage !^L
! new routine begins here indexa
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
c                     indexa
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
