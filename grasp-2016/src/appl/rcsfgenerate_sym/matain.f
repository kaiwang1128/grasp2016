*     last edited November 1, 1996
      subroutine Matain(org,lock,closed,varmax,skal,nmax,anel,par
     :                  ,low,minJ,maxJ,lim,dubbel)
      integer logfil
      parameter (logfil=31)
      integer org(1:15,0:10),anela,low(1:15,0:10),anelb,minJ,maxJ
      integer varmax,resL,i,j,skal,nmax,lmax,em,anel,par,nenter
      integer lim(15),block,mshell,enn,tmp,cormax
      character X,orb(0:10),L(0:20),Y*3
      logical lock(1:15,0:10),closed(1:15,0:10),all,
     :        dubbel(1:15,0:10),lima,open_c,clos_c
