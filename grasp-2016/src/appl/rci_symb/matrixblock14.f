************************************************************************
*                                                                      *
      SUBROUTINE MATRIXBLOCK14(IC,IR,NCOEC,INCOR,NCTEC,INC2,NMCBP,
...
*
      ...
      WRITE(*,*) 'In matrixblock14, IC,IR',IC,IR
...
!                  LABEL(3,I) = K + NTYPE(5,IC)
     ...
     :             NP(LABEL(4,I)) .EQ. NP(NTYPE(6,IC)))THEN
                  MRANK = 1
                ELSE IF(NP(LABEL(4,I)) .EQ. NP(NTYPE(4,IC)) .AND.
     :             NP(LABEL(3,I)) .EQ. NP(NTYPE(6,IC)))THEN
                  MRANK = 2
                ELSE
                  WRITE(*,*)'STOP IN 2 MATRIXBLOCK14.f'
                  STOP
                END IF
              END IF
   13       CONTINUE          
