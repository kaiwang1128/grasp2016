...
C         WRITE(80,403) Lev_POS(I),Lev_J(I),Lev_Par(I),
C     &   A(I-IZERO),B(I-IZERO),GJ(I-IZERO),trim(string_CSF(I))
C         WRITE(80,404) Lev_POS(I),Lev_J(I),Lev_Par(I),
C     &   A(I-IZERO),B(I-IZERO),GJ(I-IZERO),trim(string_CSF(I)),
C     &   RLev_ENER(I)
...
C  405 FORMAT (1X,F14.7,2X,A,2A4,1P,2D13.3,1P,D16.6)
...
* Now begin to read the hfs data
      ...
      DO
         ...
         IF (IOS.NE.0) GOTO 20
CPJ         WRITE(*,'(1P,3D20.10)') A(I),B(I),GJ(I)
         I = I + 1
      END DO
   20 CONTINUE 
