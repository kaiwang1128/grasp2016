...
*                                                                      *
      PROGRAM GENMCPMPI
      CALL genmcpmpi1234567
      END
      SUBROUTINE genmcpmpi1234567
*                                                                      *
...
! cpath uses
      ...
      CHARACTER*128 startdir, permdir, tmpdir, file_rcsl
...
*=======================================================================
     ...
     &  startdir, permdir, tmpdir, 'MCP3_MPI',lentmp,lenperm)
...
*=======================================================================
      ...
      IF (myid .EQ. 0) THEN
         WRITE (istde,*)
         WRITE (istde,'(A)',ADVANCE='YES') 
     :                      'Default settings?  (y/n)'//'\0'
         !call mp_flush(1) 
         YES = GETYN ()
         IF (YES) THEN
            NDEF = 0
