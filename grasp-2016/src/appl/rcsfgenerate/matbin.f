*     last edited August 2, 1996
   ...
   40 if (.NOT. second) then
         write(*,*)
C         write(*,*) 'You have the possibility to generate another list'
C         write(*,*) 'This list must have the same 2*J values as       '
C         write(*,*) 'previous lists of the same parity                '
C         write(*,200) 'Generate another list? (y/*)'
         read(193,1000) X
