   ...
   10       stat(n,l) = 0
     ...
     :       ' (*/r/s/u)'
      ...
      if (X.EQ.'u' .OR. X.EQ.'U') then
         ...
         num = 1
         if (.NOT.OK) then
            write(*,200) 'User defined orbital ordering selected but'
            write(*,200) 'there is no file clist.ref with orbital order'
            write(*,200) 'Please supply this file and rerun'
            stop
         else
