...
CPJ      POINTER (PNTRIQ,RIQDUMMY)
CPJ      POINTER (PNTRIQ,IQA(NNNWP,1))
CPJ      POINTER (PNTRIQ,IQ(1))
...
CPJ See SETQNA IN LIB92 THESE ARE THE OCCUPATION NUMBERS FOR LEFT AND RIGHT CSF
C     :      /M1/NQ1(NNNW),NQ2(NNNW) 
CPJ
...
*
      WRITE(*,*)"Here comes the contribution from the one-body  
     : operator "
...
*
     ...
     :                            LABEL(5,I), TEGRAL)
                  ENDIF 
                  WRITE(*,593) IC,IR,COEFF(I),'R',LABEL(5,I),'(',
     :                    NP(LABEL(1,I)),NH(LABEL(1,I)),
     :                    NP(LABEL(2,I)),NH(LABEL(2,I)),',',
     :                    NP(LABEL(3,I)),NH(LABEL(3,I)),
     :                    NP(LABEL(4,I)),NH(LABEL(4,I)),')'
