...
*                                                                      *
*   Checks if the angular file name.THD is available and appropriate   *
*                                                                      *
*   Written by Per Jonsson                      Updated July 2015      *
*                                                                      *
************************************************************************
*
...
*
      ...
      NF = 129
      J = INDEX(NAME,' ')
      INQUIRE (FILE = NAME(1:J-1)//'.THD', EXIST = FOUND)
      IF (.NOT.FOUND) THEN
        PRINT *, ' Angular data will be computed'
        AVAIL = .FALSE.
        OPEN (UNIT = NF,FILE = NAME(1:J-1)//'.THD',STATUS='NEW',
     :        FORM='UNFORMATTED')
