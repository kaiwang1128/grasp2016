...
print "   LSCOMP.PL\n";
print "   This PERL script creates files lscomp.tex and energylabel.\n";
print "   \n";
...
print "   \n";
print "   File energylabel may be used by RTABTRANS2 to produce\n";
...
print "   Output files: lscomp.tex and energylabel\n";
...
print "   Files lscomp.tex and energylabel written to disc.  \n";
print "\n";
